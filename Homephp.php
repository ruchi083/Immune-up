    ...
    <section class="u-align-center u-border-2 u-border-grey-75 u-clearfix u-image u-shading u-section-1" src="" id="sec-f618" data-image-width="5472" data-image-height="3648">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-align-center u-form u-form-1">
          <form action="reg.php" method="POST" class="u-clearfix u-form-spacing-5 u-form-vertical u-inner-form" style="padding: 0px;" source="custom" name="form">
            <div class="u-form-group u-form-name">
              <label for="name-f233" class="u-form-control-hidden u-label u-text-grey-15">Name</label>
              <input type="text" placeholder="Enter your Name"  name="name" class="u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-heading-font u-input u-input-rectangle u-text-grey-25 u-input-1" required="" autofocus="autofocus">
            </div>
            <div class="u-form-group u-form-group-2">
              <label for="text-6f74" class="u-form-control-hidden u-label u-text-grey-15"></label>
              <input type="text" placeholder="Enter your Aadhar number"  name="text" class="u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-heading-font u-input u-input-rectangle u-text-grey-25 u-input-2" required="required" maxlength="12">
            </div>
            <div class="u-form-group u-form-select u-form-group-3">
              <label for="select-b275" class="u-form-control-hidden u-label u-text-grey-15"></label>
              <div class="u-form-select-wrapper">
                <select  name="Gender" class="u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-heading-font u-input u-input-rectangle u-text-grey-25 u-input-3" required="required">
            ...
            <div class="u-form-group u-form-group-4">
              ...
              <input type="text" placeholder="Password"  name="pass" class="u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-heading-font u-input u-input-rectangle u-text-grey-25 u-input-4" required="required">
            </div>
            ...
            <div class="u-align-center u-form-group u-form-submit">
              <a href="Login.html" class="u-btn u-btn-submit u-button-style u-hover-palette-1-dark-1 u-palette-1-light-2 u-btn-1">Register<br>
              </a>
